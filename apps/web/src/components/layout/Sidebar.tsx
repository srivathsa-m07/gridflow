...
export const Sidebar: React.FC<SidebarProps> = ({ user, onLogout, isConnected }) => {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 flex w-60 flex-col border-r border-slate-800/80 bg-[#080d16]">
      {/* Logo */}
      <div className="flex h-14 items-center gap-2.5 border-b border-slate-800/80 px-5">
      ...
      {/* Org + plan badge */}
      <div className="mx-3 mt-3 rounded-lg border border-slate-800 bg-slate-900/60 px-3 py-2">
      ...
      <nav className="mt-4 flex-1 space-y-0.5 px-2">
        <p className="mb-1.5 px-3 text-[10px] font-semibold uppercase tracking-widest text-slate-600">Console</p>
        ...
        <p className="mb-1.5 px-3 text-[10px] font-semibold uppercase tracking-widest text-slate-600">Product</p>
        <Link to="/pricing"
          className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-slate-400 hover:bg-slate-800/60 hover:text-slate-200 transition-colors">
      ...
      {isFreePlan && (
        <div className="mx-3 mb-3 rounded-lg border border-slate-700/60 bg-slate-900/60 p-3">
          <p className="text-xs font-semibold text-slate-300">Upgrade to Pro</p>
          <p className="mt-0.5 text-[10px] text-slate-500">25 agents · 90-day history · priority support</p>
          <Link to="/pricing"
            className="mt-2.5 flex items-center gap-1 text-xs font-semibold text-cyan-400 hover:text-cyan-300 transition-colors">
      ...
      <div className="border-t border-slate-800/80 p-3">
        <div className="flex items-center gap-3 rounded-lg px-2 py-2">
          <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-slate-700 text-xs font-bold text-slate-200">
